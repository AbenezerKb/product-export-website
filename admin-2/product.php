...
<div class="row text-center mt-1">
    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="number" class="form-control" id="inputPrice" placeholder="Price" required>
      </div>
      ...
      <div class="form-group col-md-6">
        ...
        <select class="form-control" aria-label="Default select example" id="inputCategory" placeholder="Category">
        <?php  include("connect.php");
  
  $set="SELECT ID, category FROM categories";

  $results=$connect->query($set);

  while($final=$results->fetch_assoc()){ ?>	

            <?php echo "<option value='" . $final['category'] . "'>". $final['category'] ."</option>" ?>            
										...
										<tr>
										  ...
										  <td>
											<div class="d-flex ">                                          
                                              ...
                                              <?php echo "<h6   id='name" .$final['ID'] . "'    >" . $final['name']. "</h6>"?>                                                                                                                           
											  </div>
											</div>
										  </td>   
										  <td>
										  ...
										  <td>
											...
											<?php echo "<img src='".$final['image']."'  id='img". $final['ID'] ."' />"?>
											  </div>
...
//    event.preventDefault();  
    ...
    $(document).on('click', '.edit', function() { // Bind an event handler to the submit button
       ...
       // alert(name.innerHTML + category.innerHTML  +  price.innerHTML  +  image.innerHTML)
             document.getElementById('inputName').value = document.getElementById('name'+id).innerHTML;            
             document.getElementById('inputCategory').value = document.getElementById('cate'+id).innerHTML;            
             document.getElementById('inputPrice').value = parseInt(document.getElementById('price'+id).innerHTML);            
             document.getElementById('inputImage').value = document.getElementById('img'+id).innerHTML;            
